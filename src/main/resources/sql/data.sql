...
INSERT IGNORE INTO `spring`.`authorities` (`name`, `user_entity`) VALUES ('READ', 1);
INSERT IGNORE INTO `spring`.`authorities` (`name`, `user_entity`) VALUES ('WRITE', 1);
INSERT IGNORE INTO `spring`.`authorities` (`name`, `user_entity`) VALUES ('READ', 2);
